...
import static org.danekja.discussment.article.core.domain.User.GET_BY_USERNAME;
import static org.danekja.discussment.article.core.domain.User.GET_USERS;
