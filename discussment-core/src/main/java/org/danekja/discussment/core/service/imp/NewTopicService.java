...
public class NewTopicService implements TopicService {

    private TopicDao topicDao;
    private AccessControlService accessControlService;
    private DiscussionUserService discussionUserService;

    public NewTopicService(TopicDao topicDao, AccessControlService accessControlService, DiscussionUserService discussionUserService) {
